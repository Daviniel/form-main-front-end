...
/*função para verificar se o checkBox está selecionado plan<year */
...
checkBox = document
  ...
  .addEventListener("click", event => {
    ...
    /*para colocar cor nas checkBox selecionadas */
...
/*função para verificar o ADD ONS */
